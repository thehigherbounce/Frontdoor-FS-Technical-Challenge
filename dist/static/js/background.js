...
var apiRequest = function (endpoint, method, data) {
    if (method === void 0) { method = 'GET'; }
    return __awaiter(void 0, void 0, void 0, function () {
        var headers, init, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("".concat(API_BASE_URL).concat(endpoint), init)];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
...
chrome.runtime.onConnect.addListener(function (port) {
    ...
    port.onMessage.addListener(function (request) { return __awaiter(void 0, void 0, void 0, function () {
        var summary, response, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    summary = void 0;
                    if (!(request.command === 'HIGHLIGHT_DETECTED')) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0,_utils_api__WEBPACK_IMPORTED_MODULE_0__.apiRequest)('/openai/summary', 'POST', { 'text': request.selection })];
                case 2:
                    response = _a.sent();
                ...
                case 3:
                    ...
                    port.postMessage({ success: true, summary: summary });
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
